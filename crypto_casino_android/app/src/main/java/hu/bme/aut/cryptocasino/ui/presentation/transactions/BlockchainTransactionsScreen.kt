...
import hu.bme.aut.cryptocasino.ui.components.BlockchainTransactionItem
...
fun BlockchainTransactionsScreen(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        if (!hasWallet) {
            NoWalletTransactionsContent(onNavigateToWallet = onNavigateToWallet)
            return@Box
        }
...
@Composable
fun NoWalletTransactionsContent(onNavigateToWallet: () -> Unit) {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(16.dp),
        ...
        Text(
            text = "You need to add or create a wallet to view your transactions",
